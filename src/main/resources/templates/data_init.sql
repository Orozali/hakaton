...
INSERT INTO Department (id, name, institute) VALUES (nextval('department_seq'), 'Gida Department', 'Kyrghyz Turkish Manas University');
INSERT INTO Department (id, name, institute) VALUES (nextval('department_seq'), 'Economics Department', 'Kyrghyz Turkish Manas University');
...
INSERT INTO Application (id, status, student_id, exam_id, department_id, rating)
VALUES (nextval('application_seq'), 'PENDING', 1, 1,1, 0),
        (nextval('application_seq'), 'PENDING', 2, 2, 2,0),
        (nextval('application_seq'), 'PENDING', 3, 3, 3, 0);
