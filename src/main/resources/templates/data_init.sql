...
INSERT INTO Exam (id, name, date, time, duration) VALUES (nextval('exam_seq'), 'sample', '2024-01-01', '12:10:00', 120);

INSERT INTO Exam_Paper(id, exam_id) VALUES (nextval('exam_paper_seq'), 1);

INSERT INTO Application (id, status, student_id) VALUES (nextval('application_seq'), 'PENDING', 1)
